...
import { MarkedOptions } from './type';
...
export class Lexer {
  ...
  tokens: any[] & {links?:any};

  constructor(options?: MarkedOptions) {
    this.tokens = [];
    this.tokens.links = Object.create(null);
    this.options = options || getDefaults();
    this.options.tokenizer = this.options.tokenizer || new Tokenizer(this.options);
